...
# Load the dataset2
dataset2 = pd.read_csv("E:\data mining prj 1\project1_dataset2.txt", header=None, sep='\t')
...
# Check for columns with categorical data ('Present'/'Absent' values)
# and convert them to numerical format using one-hot encoding.
# Identify categorical columns. In this example, let's assume column 4 is categorical.
# This is based on your dataset; you might need to adjust the column index.
categorical_columns = [4] # Adjust based on your dataset's actual columns

# Apply one-hot encoding to these columns
dataset2 = pd.get_dummies(dataset2, columns=categorical_columns)
